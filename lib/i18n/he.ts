...
export const he: Record<TranslationKeys, string> = {
  ...
  gamezonesBy: 'Gamezones של',
  noGamezonesPublished: 'אין Gamezones שפורסמו עדיין.',
  category: 'קטגוריה',
  categories: 'קטגוריות',
  openRoomsSection: 'חדרים פתוחים',
  joinRoomTitle: 'הצטרף לחדר',
  gamezoneLabel: 'Gamezone',
  roomNameTooLong: 'שם החדר חייב להיות עד 40 תווים',
  failedToJoinRoom: 'הצטרפות לחדר נכשלה',
  ...
  newGamezoneBtn: '+ חדש',
  noGamezonesYet: 'אין Gamezones עדיין.',
  createFirstGamezone: 'צור את ה-Gamezone הראשון שלך',
  edit: 'עריכה',
  delete: 'מחיקה',

  // gamezone — new / edit
  newGamezoneTitle: 'Gamezone חדש',
  editGamezoneTitle: 'עריכת Gamezone',
  gamezoneNameLabel: 'שם ה-Gamezone',
  categoriesSection: 'קטגוריות',
  categoryNamePlaceholder: 'שם קטגוריה',
  addWordPlaceholder: 'הוסף מילה...',
  addWord: 'הוסף',
  minTwoWords: 'הוסף לפחות 2 מילים לקטגוריה זו',
  addCategory: '+ הוסף קטגוריה',
  saveGamezone: 'שמור Gamezone',
  saveChanges: 'שמור שינויים',
  saving: 'שומר...',
  gamezoneNameRequired: 'שם ה-Gamezone נדרש',
  allCategoriesNeedName: 'לכל הקטגוריות חייב להיות שם',
  categoryNeedsWords: 'קטגוריה "{name}" זקוקה לפחות ל-2 מילים',
  failedToCreateGamezone: 'יצירת ה-Gamezone נכשלה',
