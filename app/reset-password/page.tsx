  ...
  if (!token) {
    return (
      <div className="space-y-4 text-center">
        <p className="text-muted font-body text-sm">{t('invalidResetLink')}</p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-2">
        <label className="block text-xs text-muted font-body uppercase tracking-widest">{t('newPasswordLabel')}</label>
        <PasswordInput
          value={password}
      ...
      <div className="space-y-2">
        <label className="block text-xs text-muted font-body uppercase tracking-widest">{t('confirmNewPasswordLabel')}</label>
        <PasswordInput
    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted font-body text-sm">{t('setNewPasswordTitle')}</p>
        </div>

        <Suspense fallback={<p className="text-muted font-body text-sm text-center">{t('loading')}</p>}>
          <ResetPasswordForm />
        </Suspense>
